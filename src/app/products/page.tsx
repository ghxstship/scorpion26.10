...
const programs = [
  {
    ...
    description: 'Stop lurking. Community access is literally $60. What\'s your excuse? Join Team456 and get access to group workouts, basic programming, and a community that actually shows up.',
    tier: 'Foundation',
    price: 60,
    priceLabel: '/month',
    capacity: null,
  ...
  },
  {
    ...
    features: [
      ...
      'Progress tracking',
      'Private Team456 Support Group Access',
    ],
    cta: 'Join Strong_AF',
    highlight: false,
  },
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-24">
          {programs.map((program) => {
            ...
            return (
              <Card 
                key={program.id} 
                className={`group flex flex-col ${isHighlight ? 'border-2 border-[var(--gold-600)] ' : ''}`}
              >
                <CardHeader>
                  {/* Tier Badge & Capacity */}
