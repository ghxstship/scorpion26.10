...
COMMENT ON TABLE user_program_enrollments IS 'User enrollments in training programs (BasicAF, StrongAF, RareAF, FarAF)';
COMMENT ON TABLE training_sessions IS 'Individual training sessions for enrolled users';
COMMENT ON TABLE program_waitlist IS 'Waitlist for programs at capacity (RareAF, FarAF)';
